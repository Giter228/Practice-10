...
{
    public class Admin : User, ICRUD   // НУЖНО НАСЛЕДОВАТЬ ИНТЕРЕФЕЙС ICRUD
    {
        private int number;
        ...
        {
            output_Users = JustConvert.Deserealization(); // лист для вывода всех пользователей
